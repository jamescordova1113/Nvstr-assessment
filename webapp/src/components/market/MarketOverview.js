...
const MarketOverview = (props) => {
  ...
  return (
    <div className="stock-overview">
      <p className="stock-overview__name">{securityPrice.name} ({securityPrice.symbol})</p>
      <CustomMarketValue pricePercentage = {securityPrice.current_price_change_percent} />
    </div>
  )
};
